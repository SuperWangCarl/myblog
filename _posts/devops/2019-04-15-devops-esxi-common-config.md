...
![img](../../assets/images/blog/2019/20190414233808.png)
...
![img](../../assets/images/blog/2019/20190414234105.png)
...
![img](../../assets/images/blog/2019/20190414234253.png)
...
![img](../../assets/images/blog/2019/20190414234314.png)

配置dns

![img](../../assets/images/blog/2019/20190414234342.png)
...
![img](../../assets/images/blog/2019/20190415000313.png)
...
![img](../../assets/images/blog/2019/20190414234413.png)

![img](../../assets/images/blog/2019/20190414234518.png)

#### 网页客户端配置

![img](../../assets/images/blog/2019/20190415001230.png)
...
![img](../../assets/images/blog/2019/20190414224305.png)

下面进行激活,输入激活码(可以在网上随便找个)

![img](../../assets/images/blog/2019/20190414224357.png)

此时在回到主机里面看下,就是激活的状态了

![img](../../assets/images/blog/2019/20190414224452.png)
...
1. 首先点击导航栏的存储
   ...
   ![img](../../assets/images/blog/2019/20190415222112.png)

2. 可以看到此时我们的数据存储中有一块硬盘,而设备里面有两块硬盘`我们要把设备里面的硬盘添加到数据存储里面`

   ![img](../../assets/images/blog/2019/20190415222149.png)

3. 选择`新建数据存储`

   ![img](../../assets/images/blog/2019/20190415222313.png)

4. 选中`创建新的`下一步

   ![img](../../assets/images/blog/2019/20190415222847.png)

5. 起个名字创建新的 下一步

   ![img](../../assets/images/blog/2019/20190415222949.png)

6. 分配容量 下一步

   ![img](../../assets/images/blog/2019/20190415223036.png)

7. 完成

   ![img](../../assets/images/blog/2019/20190415223110.png)

8. 点击`是` 之后可以查看分配后的容量

   ![img](../../assets/images/blog/2019/20190415223146.png)
...
1. 获取需要挂在的硬盘的设备和名称
   ...
   ![img](../../assets/images/blog/2019/20190421150718.png)

   ![img](../../assets/images/blog/2019/20190421150600.png)

2. 获取被挂在点的路径

   ![img](../../assets/images/blog/2019/20190421150753.png)

   ![img](../../assets/images/blog/2019/20190421150435.png)
...
3. 在shell命令行中进行挂在
   ...
   ![img](../../assets/images/blog/2019/20190421150955.png)


4. 查看

   ![img](../../assets/images/blog/2019/20190421151039.png)

5. 使用

   添加虚拟机的时候删除默认硬盘

   ![img](../../assets/images/blog/2019/20190421151259.png)

   添加现有硬盘

   ![img](../../assets/images/blog/2019/20190421151355.png)

   选中我们创建的即可

   ![img](../../assets/images/blog/2019/20190421151426.png)
...
![img](../../assets/images/blog/2019/20190419164708.png)
...
![img](../../assets/images/blog/2019/20190419170216.png)
...
![img](../../assets/images/blog/2019/20190419170325.png)
...
![img](../../assets/images/blog/2019/20190419170546.png)
...
![img](../../assets/images/blog/2019/20190419170718.png)
...
2. 将证书传到根目录中
   ...
   ![img](../../assets/images/blog/2019/20190416003742.png)
...
4. 效果
   ...
   ![img](../../assets/images/blog/2019/20190416004221.png)
...
1. 选中需要自动启动的虚拟机,右键
   ...
   ![img](../../assets/images/blog/2019/20190415001605.png)

2. 选中自动启动

   ![img](../../assets/images/blog/2019/20190415001702.png)

3. 配置EXSI

   ![img](../../assets/images/blog/2019/20190415001801.png)

   ![img](../../assets/images/blog/2019/20190415001836.png)

4. 之后会在下载看到,开机自动启动的设备

   ![img](../../assets/images/blog/2019/20190415001909.png)
...
1. 创建新的虚拟机
   ...
   ![img](../../assets/images/blog/2019/20190415235245.png)

2. 起个名称选系统

   ![img](../../assets/images/blog/2019/20190415235344.png)

3. 此处我们先选系统盘`等虚拟机创建好了,再选数据盘`

   ![img](../../assets/images/blog/2019/20190415235428.png)

4. 选择合适的配置

   ![img](../../assets/images/blog/2019/20190416005412.png)

5. 最后看下配置点完成

   ![img](../../assets/images/blog/2019/20190416005451.png)

6. 配置完成点击虚拟机,之后打开电源,开始安装

   ![img](../../assets/images/blog/2019/20190416005536.png)

7. 安装完成后,将网卡的网段,设置为和exsi同一个网段即可

   ![img](../../assets/images/blog/2019/20190416005953.png)

### 为虚拟机分配数据盘

1. 点击`编辑`

   ![img](../../assets/images/blog/2019/20190416171105.png)

2. 点击`添加硬盘->新硬盘->再点击出现的新硬盘`为它分配机械硬盘

   ![img](../../assets/images/blog/2019/20190416171157.png)

3. 在数据盘中创建`data/main-centos`目录将磁盘挂到这里面

   ![img](../../assets/images/blog/2019/20190416171256.png)

4. 无需重启直接登录服务器查看

   ![img](../../assets/images/blog/2019/20190416171352.png)

### 三类磁盘的区别

![img](../../assets/images/blog/2019/20190416171413.png)
...
![img](../../assets/images/blog/2019/20190414235143.png)
...
![img](../../assets/images/blog/2019/20190415221133.png)
...
![img](../../assets/images/blog/2019/20190416001509.png)
