...
![img](../../assets/images/blog/2019/20190414185851.png)
...
![img](../../assets/images/blog/2019/20190414185756.png)

### 2. 按F2后

主要就是设置一些系统的配置,一电脑中的bios设置有点像,这里我只设置了`cpu的虚拟化支持`

![img](../../assets/images/blog/2019/20190414190204.png)

### 3. 按F10后

主要是一些图形化操作的系统配置,比如raid,bios之类的

![img](../../assets/images/blog/2019/20190414190443.png)

#### 1. raid的配置(也可以开机之后按 Ctrl+R进行配置)

选中`Configuration Wizards`

![img](../../assets/images/blog/2019/20190414190548.png)

选中`RAID Configuration`

![img](../../assets/images/blog/2019/20190414190639.png)

之后可以按照自己的需求配置,`在这里之前我在 其他地方已经配置过raid了,后面介绍`

![img](../../assets/images/blog/2019/20190414190709.png)

#### 2. bios设置(也可以开机后按F2进行配置)

选中`HII Advanced Configuration`

![img](../../assets/images/blog/2019/20190414190836.png)

选中 `System BIOS Settings`

![img](../../assets/images/blog/2019/20190414190925.png)

其实这里的配置 和开机的时候按`F2`的配置是差不多的,只不过这里是图形化的

![img](../../assets/images/blog/2019/20190414191009.png)
...
![img](../../assets/images/blog/2019/20190421222819.png)

### 4. 按F11后

主要设置bois的启动顺序的

![img](../../assets/images/blog/2019/20190414190019.png)

### 5. 开机后的其他按键

- Ctrl + S 

  ![img](../../assets/images/blog/2019/20190414191513.png)

- Ctrl + R RAID的配置

  1. 按下Ctrl+R

  ![img](../../assets/images/blog/2019/20190414191534.png)

  2. 进入配置页

     ![img](../../assets/images/blog/2019/20190414191636.png)

  3. 按下`F2`弹出菜单,选择`Create New VD`

     ![img](../../assets/images/blog/2019/20190414191654.png)

  4. 配置RAID,之后选择OK即可

     ![img](../../assets/images/blog/2019/20190414191844.png)

- Ctrl + E  iDRAC的远程卡的网络配置

  ![img](../../assets/images/blog/2019/20190414191454.png)
...
1. 首先要已经有存在的磁盘组（阵列），我们这里举例为已经配置了两个阵列，阵列0是由0、1、2三块物理磁盘配置的RAID5，阵列1是由4、5两块物理磁盘配置的RAID1，如图：
   ...
   ![img](../../assets/images/blog/2019/20190414193019.png)

2. 按CTRL+N 切换至PD Mgmt界面，可以看到4号硬盘的状态是Ready。

   ![img](../../assets/images/blog/2019/20190414193039.png)

3. 将光标移至4号硬盘，按F2，在弹出的菜单中，选择Make Global HS，配置全局的热备盘

   ![img](../../assets/images/blog/2019/20190414193120.png)

4. 确认后，4号硬盘的状态变为Hotspare

   ![img](../../assets/images/blog/2019/20190414193142.png)

5. 配置完成后，可以看到磁盘组0与磁盘组1的热备盘都是同一个

   ![img](../../assets/images/blog/2019/20190414193208.png)

6. 移除热备，进入PD Mgmt菜单，将光标移至热备盘处，按F2，选择Remove Hot Spare，回车移除

   ![img](../../assets/images/blog/2019/20190414193232.png)

#### 配置独立热备

1. 在配置好的虚拟磁盘管理界面下，将光标移至需要配置独立热备的磁盘组上，按F2键，在出现的菜单中选择 Manage Ded. HS

   ![img](../../assets/images/blog/2019/20190414193312.png)

2. 将光标移至需要配置为热备的硬盘上，按空格键，看到X标识，说明此硬盘被选择。将光标移至OK处回车，完成配置

   ![img](../../assets/images/blog/2019/20190414193335.png)

3. 可以看到磁盘组0已经有了热备盘，并且是Dedicated。而磁盘组1并没有热备盘。

   ![img](../../assets/images/blog/2019/20190414193403.png)

4. 移除热备，同第1步，将光标移至需要移除热备的磁盘组上，按F2键，在出现的菜单中选择 Manage Ded. HS

   ![img](../../assets/images/blog/2019/20190414193424.png)

5. 将光标移至需要移除的热备硬盘上，按空格键，去掉X标识，说明此硬盘被移除。将光标移至OK处回车，完成热备移除。

   ![img](../../assets/images/blog/2019/20190414193449.png)
...
1. 初始化
   ...
   ![img](../../assets/images/blog/2019/20190421153256.png)

2. 其他

   ![img](../../assets/images/blog/2019/20190421154215.png)

   ![img](../../assets/images/blog/2019/20190421154322.png)
...
![img](../../assets/images/blog/2019/20190421145006.png)
...
![img](../../assets/images/blog/2019/20190421152303.png)
...
3. 如磁盘状态为foreign，进入VD Mgmt中选择contrllor 0,按F2，选择foreign，选择clear;选择import会导入该磁盘的raid配置
   ...
   ![img](../../assets/images/blog/2019/20190421152455.png)
...
![img](../../assets/images/blog/2019/20190421153626.png)
